...
public class ContaValidador {
    ...
    public static void validarCamposObrigatorios(
            ...
            String roleSecundaria,
            String championFavorito,
            String servidor
    ) {


        if (campoVazio(nickname) ||
                campoVazio(tag) ||
                campoVazio(senha) ||
                campoVazio(email) ||
                campoVazio(level) ||
                campoVazio(elo) ||
                campoVazio(rolePrincipal) ||
                campoVazio(roleSecundaria) ||
                campoVazio(championFavorito) ||
                campoVazio(servidor)) {
    ...
    public static int validarLevel(String level) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "O campo Level deve conter apenas números."
            );
